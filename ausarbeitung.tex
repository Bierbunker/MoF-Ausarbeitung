...
\begin{figure}[H]  
    \centering
    \includegraphics[width=.6\textwidth]{resources/05-01-2015/Frage6_1.png}
    \caption{Inelastische Streuung an Phononen}
\end{figure}

\begin{figure}[H]  
    \centering
    \includegraphics[width=.6\textwidth]{resources/05-01-2015/Frage6_2.png}
...
variieren können. \\
In der Quantenmechanik können die Energieniveaus nur diskrete Werte annehmen, wodurch die 
...
\begin{figure}[H]  
    \centering
    \includegraphics[width=.6\textwidth]{resources/05-01-2015/Frage7.png}
