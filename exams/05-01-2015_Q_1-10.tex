...
\[\Delta E_{rot} = \frac{(J+1)\hbar^2}{M\cdot {R_e}^2}\]  %TODO: 2B(J+1)
...
% TODO: nur in Größenordnung von Thomas-Fermi-Radius (Abschirmradius) relevant, Bild einfügen
% TODO: Anziehende Coulomb-WW weitgehend durch abstoßende Pauli-WW kompensiert
% TODO: Formel für Coulomb-Potential mit exponentiellem Abfall, Kapitel 12
% TODO: S. 414!!
