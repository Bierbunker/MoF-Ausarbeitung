...
Beruht auf dem Prinzip, dass Zeitskalen der Anregung $\nu_{el} \approx 10^{15} \si{\hertz}$ zwei bis drei Grö0enordnungen schneller als Kernschwingungen $\nu_{N} \approx 10^{13} \si{\hertz}$ sind. 
...
Der Strukturfaktor ist die Fourier-Transofmierte $n_{\Vec{G}}$ der Elektronendichte $ n(\vec{r})$ über eine Einheitszelle. 
\begin{align}
